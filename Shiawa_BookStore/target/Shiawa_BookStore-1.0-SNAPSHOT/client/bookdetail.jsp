...
<html>
    ...
    <body>
        ...
        <div class="mt-5">
                ...
                <div class="card mb-3 border-0 border-bottom">
                    <div class="form-container">
                        <c:if test="${fb.userId == sessionScope.user.id}">
                            ...
                            <%-- Nút Sửa: Nếu hết hạn (isExpired) thì gọi alert, ngược lại thì chuyển trang --%>
                            <div class="edit-btn" style="cursor: pointer; color: #e53935; font-weight: bold;" 
                                 onclick="checkEditStatus(${isExpired}, '${pageContext.request.contextPath}/feedback?book_id=${fb.bookId}&order_detail_id=${fb.orderdetailId}')">
            ...
            <%-- Thêm đoạn script này ở cuối trang --%>
            <script>
