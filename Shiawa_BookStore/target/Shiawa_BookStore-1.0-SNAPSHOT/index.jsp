            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        <a href="customer" class="nav-item nav-link active"><i class="fa fa-users me-2"></i>User</a>
                        <a href="book.jsp" class="nav-item nav-link"><i class="fa fa-book me-2"></i>Book</a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-2">
                                                    <a href="customer?view=detail&id=${c.id}" class="btn btn-sm btn-primary">Detail</a>
                                                    <a href="customer?view=edit&id=${c.id}" class="btn btn-sm btn-warning">Edit</a>
                                                    <a href="customer?view=delete&id=${c.id}" class="btn btn-sm btn-danger"
