<<<<<<< HEAD
<%-- Document : home Created on : Jan 30, 2026, 2:18:34 PM Author : Lenovo --%>
...
<div class="book" data-category="${b.category.cateName}" data-name="${b.title}"
                                    ...
                                    <button type="button" class="add-cart"
                                        onclick="event.preventDefault(); addToCart('${b.bookId}')">
                                        Thêm giỏ hàng
                                    </button>
                                </div>
                            </a>
                        ...
                        <div class="book" data-category="Business" data-name="Bùi Kiến Thành – Người Mở Khóa"
                            data-price="150000">
                        ...
                        <div class="book" data-category="Mystery" data-name="Những Mô Hình Tư Duy Vĩ Đại"
                            data-price="180000">
                            <img src="https://via.placeholder.com/160x220">
